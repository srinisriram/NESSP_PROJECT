...
class EmailSender:
    ...
    def send_email(cls, enter_excel_sheet=ENTER_LOG_FILE_NAME, exit_excel_sheet=EXIT_LOG_FILE_NAME):
        ...
        receiver_email = "srinivassriram06@gmail.com, abhisar.muz@gmail.com"
        password = "LearnIOT06!"
        ...
        part.add_header('Content-Disposition', 'attachment; filename="enter_file.csv"')
        part2 = MIMEBase('application', "octet-stream")
        part2.set_payload(open(exit_excel_sheet, "rb").read())
        encoders.encode_base64(part2)
        part2.add_header('Content-Disposition', 'attachment; filename="exit_file.csv"')
        msg.attach(part)
        msg.attach(part2)
